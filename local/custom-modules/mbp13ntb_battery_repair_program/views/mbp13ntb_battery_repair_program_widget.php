<div class="col-lg-4 col-md-6">
	<div class="panel panel-default" id="mbp13ntb_battery_repair_program-state-widget">
		<div class="panel-heading" data-container="body" data-i18n="[title]mbp13ntb_battery_repair_program.mbp13ntb_battery_repair_program">
			<h3 class="panel-title"><i class="fa fa-battery-three-quarters"></i>
				<span data-i18n="mbp13ntb_battery_repair_program.state"></span>
				—&nbsp;<a href="https://support.apple.com/13inch-macbookpro-battery-replacement" target="_blank" data-i18n="mbp13ntb_battery_repair_program.battery_program_url"></a>
                <list-link data-url="/show/listing/mbp13ntb_battery_repair_program/mbp13ntb_battery_repair_program"></list-link>
			</h3>
		</div>
...
$(document).on('appUpdate', function(e, lang) {
    ...
    $.getJSON( appUrl + '/module/mbp13ntb_battery_repair_program/get_mbp13ntb_battery_repair_program_state', function( data ) {
		...
		var panel = $('#mbp13ntb_battery_repair_program-state-widget div.panel-body'),
			baseUrl = appUrl + '/show/listing/mbp13ntb_battery_repair_program/mbp13ntb_battery_repair_program';
		panel.empty();
