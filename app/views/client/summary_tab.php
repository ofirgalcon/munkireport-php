...
<div class="row" style="margin-top: 20px">
    ...
    <div class="row">
        ...
        <div class="col-lg-4 hidden-obj">
            <h4><i class="fa fa-microchip"></i> <span data-i18n="geekbench.geekbench"></span></h4>
            <table>
                <tr>
                    <th data-i18n="geekbench.score"></th><td class="mr-score"></td>
                </tr>
                <tr>
                    <th data-i18n="geekbench.multiscore"></th><td class="mr-multiscore"></td>
                </tr>
                </tr>
            </table>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-lg-4">
            ...
            <table>
                <tr>
                    <th data-i18n="warranty.coverage"></th><td class="mr-warranty_statu"><a href="https://checkcoverage.apple.com/" target="_blank">Check Warranty</a></td>
                </tr>
                <tr>
